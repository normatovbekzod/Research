...
\newcommand{\AckQJMAMFund}[1]{#1 gratefully acknowledges support from the QJMAM Fund for Applied Mathematics.}
\newcommand{\AckYNCSPRG}[1]{#1 gratefully acknowledges support from Yale-NUS College special pocket research grant \emph{Linear initial boundary value problems with exotic boundary conditions}.}
\newcommand{\AckYNCSeed}[1]{#1 gratefully acknowledges support from Yale-NUS College seed grant IG21-SG101.}
